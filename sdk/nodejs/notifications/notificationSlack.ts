 ...
 *
 * const example = new whisparr.notifications.NotificationSlack("example", {
 ...
 *
 * ```sh
 *  $ pulumi import whisparr:Notifications/notificationSlack:NotificationSlack example 1
 * ```
 */
export class NotificationSlack extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'whisparr:Notifications/notificationSlack:NotificationSlack';
