 ...
 *
 * const example = new whisparr.notifications.NotificationProwl("example", {
 *     apiKey: "APIKey",
 ...
 *
 * ```sh
 *  $ pulumi import whisparr:Notifications/notificationProwl:NotificationProwl example 1
 * ```
 */
export class NotificationProwl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'whisparr:Notifications/notificationProwl:NotificationProwl';
