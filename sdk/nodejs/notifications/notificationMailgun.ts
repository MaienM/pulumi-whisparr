 ...
 *
 * const example = new whisparr.notifications.NotificationMailgun("example", {
 *     apiKey: "APIkey",
 ...
 *
 * ```sh
 *  $ pulumi import whisparr:Notifications/notificationMailgun:NotificationMailgun example 1
 * ```
 */
export class NotificationMailgun extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'whisparr:Notifications/notificationMailgun:NotificationMailgun';
