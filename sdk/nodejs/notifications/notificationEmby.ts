 ...
 *
 * const example = new whisparr.notifications.NotificationEmby("example", {
 *     apiKey: "API_Key",
 *     host: "emby.lcl",
 ...
 *
 * ```sh
 *  $ pulumi import whisparr:Notifications/notificationEmby:NotificationEmby example 1
 * ```
 */
export class NotificationEmby extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'whisparr:Notifications/notificationEmby:NotificationEmby';
