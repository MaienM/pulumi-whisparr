 ...
 *
 * const example = new whisparr.notifications.NotificationBoxcar("example", {
 ...
 *
 * ```sh
 *  $ pulumi import whisparr:Notifications/notificationBoxcar:NotificationBoxcar example 1
 * ```
 */
export class NotificationBoxcar extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'whisparr:Notifications/notificationBoxcar:NotificationBoxcar';
