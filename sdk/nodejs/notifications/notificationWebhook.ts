 ...
 *
 * const example = new whisparr.notifications.NotificationWebhook("example", {
 ...
 *
 * ```sh
 *  $ pulumi import whisparr:Notifications/notificationWebhook:NotificationWebhook example 1
 * ```
 */
export class NotificationWebhook extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'whisparr:Notifications/notificationWebhook:NotificationWebhook';
