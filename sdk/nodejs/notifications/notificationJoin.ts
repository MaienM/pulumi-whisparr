 ...
 *
 * ```sh
 *  $ pulumi import whisparr:Notifications/notificationJoin:NotificationJoin example 1
 * ```
 */
export class NotificationJoin extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'whisparr:Notifications/notificationJoin:NotificationJoin';
