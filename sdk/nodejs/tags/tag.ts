 ...
 *
 * const example = new whisparr.tags.Tag("example", {label: "some-value"});
 * ```
 *
 * ## Import
 *
 ...
 *
 * ```sh
 *  $ pulumi import whisparr:Tags/tag:Tag example 10
 * ```
 */
export class Tag extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'whisparr:Tags/tag:Tag';
