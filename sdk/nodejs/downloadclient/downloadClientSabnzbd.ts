 ...
 *
 * const example = new whisparr.downloadclient.DownloadClientSabnzbd("example", {
 *     apiKey: "test",
 *     enable: true,
 *     host: "sabnzbd",
 *     name: "Example",
 ...
 *
 * ```sh
 *  $ pulumi import whisparr:DownloadClient/downloadClientSabnzbd:DownloadClientSabnzbd example 1
 * ```
 */
export class DownloadClientSabnzbd extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'whisparr:DownloadClient/downloadClientSabnzbd:DownloadClientSabnzbd';
