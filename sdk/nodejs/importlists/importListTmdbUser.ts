 ...
 *
 * ```sh
 *  $ pulumi import whisparr:ImportLists/importListTmdbUser:ImportListTmdbUser example 1
 * ```
 */
export class ImportListTmdbUser extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'whisparr:ImportLists/importListTmdbUser:ImportListTmdbUser';
