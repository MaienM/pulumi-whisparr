 ...
 *
 * const example = new whisparr.importlists.ImportListImdb("example", {
 *     enableAuto: false,
 *     enabled: true,
 *     listId: "ls12345678",
 ...
 *
 * ```sh
 *  $ pulumi import whisparr:ImportLists/importListImdb:ImportListImdb example 1
 * ```
 */
export class ImportListImdb extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'whisparr:ImportLists/importListImdb:ImportListImdb';
