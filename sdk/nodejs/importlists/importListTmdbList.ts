 ...
 *
 * const example = new whisparr.importlists.ImportListTmdbList("example", {
 *     enableAuto: false,
 *     enabled: true,
 *     listId: "11842",
 ...
 *
 * ```sh
 *  $ pulumi import whisparr:ImportLists/importListTmdbList:ImportListTmdbList example 1
 * ```
 */
export class ImportListTmdbList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'whisparr:ImportLists/importListTmdbList:ImportListTmdbList';
