 ...
 *
 * const example = new whisparr.importlists.ImportListTraktList("example", {
 *     accessToken: "Token",
 *     authUser: "User1",
 *     enableAuto: false,
 *     enabled: true,
 ...
 *
 * ```sh
 *  $ pulumi import whisparr:ImportLists/importListTraktList:ImportListTraktList example 1
 * ```
 */
export class ImportListTraktList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'whisparr:ImportLists/importListTraktList:ImportListTraktList';
