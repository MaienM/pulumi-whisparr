 ...
 *
 * const example = new whisparr.importlists.ImportListTmdbKeyword("example", {
 *     enableAuto: false,
 *     enabled: true,
 *     keywordId: "11842",
 ...
 *
 * ```sh
 *  $ pulumi import whisparr:ImportLists/importListTmdbKeyword:ImportListTmdbKeyword example 1
 * ```
 */
export class ImportListTmdbKeyword extends pulumi.CustomResource {
    /**
     * Get an existing ImportListTmdbKeyword resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ImportListTmdbKeywordState, opts?: pulumi.CustomResourceOptions): ImportListTmdbKeyword {
        return new ImportListTmdbKeyword(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'whisparr:ImportLists/importListTmdbKeyword:ImportListTmdbKeyword';

    /**
     * Returns true if the given object is an instance of ImportListTmdbKeyword.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ImportListTmdbKeyword {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ImportListTmdbKeyword.__pulumiType;
    }
    ...
    /**
     * Create a ImportListTmdbKeyword resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ImportListTmdbKeywordArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ImportListTmdbKeywordArgs | ImportListTmdbKeywordState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ImportListTmdbKeywordState | undefined;
            ...
            const args = argsOrState as ImportListTmdbKeywordArgs | undefined;
            if ((!args || args.keywordId === undefined) && !opts.urn) {
                throw new Error("Missing required property 'keywordId'");
            }
        ...
        super(ImportListTmdbKeyword.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * Input properties used for looking up and filtering ImportListTmdbKeyword resources.
 */
export interface ImportListTmdbKeywordState {
    /**
     * Enable automatic add flag.
     */
...
/**
 * The set of arguments for constructing a ImportListTmdbKeyword resource.
 */
export interface ImportListTmdbKeywordArgs {
    /**
     * Enable automatic add flag.
     */
    enableAuto?: pulumi.Input<boolean>;
