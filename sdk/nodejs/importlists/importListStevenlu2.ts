 ...
 *
 * const example = new whisparr.importlists.ImportListStevenlu2("example", {
 *     enableAuto: false,
 *     enabled: true,
 *     minScore: 5,
 ...
 *
 * ```sh
 *  $ pulumi import whisparr:ImportLists/importListStevenlu2:ImportListStevenlu2 example 1
 * ```
 */
export class ImportListStevenlu2 extends pulumi.CustomResource {
    /**
     * Get an existing ImportListStevenlu2 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ImportListStevenlu2State, opts?: pulumi.CustomResourceOptions): ImportListStevenlu2 {
        return new ImportListStevenlu2(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'whisparr:ImportLists/importListStevenlu2:ImportListStevenlu2';

    /**
     * Returns true if the given object is an instance of ImportListStevenlu2.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ImportListStevenlu2 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ImportListStevenlu2.__pulumiType;
    }
    ...
    /**
     * Create a ImportListStevenlu2 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ImportListStevenlu2Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ImportListStevenlu2Args | ImportListStevenlu2State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ImportListStevenlu2State | undefined;
            ...
            const args = argsOrState as ImportListStevenlu2Args | undefined;
            if ((!args || args.minScore === undefined) && !opts.urn) {
                throw new Error("Missing required property 'minScore'");
            }
        ...
        super(ImportListStevenlu2.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * Input properties used for looking up and filtering ImportListStevenlu2 resources.
 */
export interface ImportListStevenlu2State {
    /**
     * Enable automatic add flag.
     */
...
/**
 * The set of arguments for constructing a ImportListStevenlu2 resource.
 */
export interface ImportListStevenlu2Args {
    /**
     * Enable automatic add flag.
     */
    enableAuto?: pulumi.Input<boolean>;
