 ...
 *
 * const example = new whisparr.importlists.ImportListTmdbCollection("example", {
 *     collectionId: "11842",
 *     enableAuto: false,
 *     enabled: true,
 ...
 *
 * ```sh
 *  $ pulumi import whisparr:ImportLists/importListTmdbCollection:ImportListTmdbCollection example 1
 * ```
 */
export class ImportListTmdbCollection extends pulumi.CustomResource {
    /**
     * Get an existing ImportListTmdbCollection resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ImportListTmdbCollectionState, opts?: pulumi.CustomResourceOptions): ImportListTmdbCollection {
        return new ImportListTmdbCollection(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'whisparr:ImportLists/importListTmdbCollection:ImportListTmdbCollection';

    /**
     * Returns true if the given object is an instance of ImportListTmdbCollection.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ImportListTmdbCollection {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ImportListTmdbCollection.__pulumiType;
    }
    ...
    /**
     * Create a ImportListTmdbCollection resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ImportListTmdbCollectionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ImportListTmdbCollectionArgs | ImportListTmdbCollectionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ImportListTmdbCollectionState | undefined;
            ...
            const args = argsOrState as ImportListTmdbCollectionArgs | undefined;
        ...
        super(ImportListTmdbCollection.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * Input properties used for looking up and filtering ImportListTmdbCollection resources.
 */
export interface ImportListTmdbCollectionState {
    /**
     * Collection ID.
     */
...
/**
 * The set of arguments for constructing a ImportListTmdbCollection resource.
 */
export interface ImportListTmdbCollectionArgs {
    /**
     * Collection ID.
     */
    collectionId: pulumi.Input<string>;
