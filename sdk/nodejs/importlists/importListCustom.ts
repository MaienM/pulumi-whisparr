 ...
 *
 * const example = new whisparr.importlists.ImportListCustom("example", {
 *     enableAuto: false,
 *     enabled: true,
 ...
 *
 * ```sh
 *  $ pulumi import whisparr:ImportLists/importListCustom:ImportListCustom example 1
 * ```
 */
export class ImportListCustom extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'whisparr:ImportLists/importListCustom:ImportListCustom';
