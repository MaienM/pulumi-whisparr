 ...
 *
 * const example = new whisparr.importlists.ImportListPlex("example", {
 ...
 *
 * ```sh
 *  $ pulumi import whisparr:ImportLists/importListPlex:ImportListPlex example 1
 * ```
 */
export class ImportListPlex extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'whisparr:ImportLists/importListPlex:ImportListPlex';
