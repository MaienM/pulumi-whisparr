 ...
 *
 * const example = new whisparr.importlists.ImportListRss("example", {
 *     enableAuto: false,
 *     enabled: true,
 ...
 *
 * ```sh
 *  $ pulumi import whisparr:ImportLists/importListRss:ImportListRss example 1
 * ```
 */
export class ImportListRss extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'whisparr:ImportLists/importListRss:ImportListRss';
