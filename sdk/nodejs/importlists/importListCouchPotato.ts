 ...
 *
 * const example = new whisparr.importlists.ImportListCouchPotato("example", {
 *     apiKey: "APIKey",
 *     enableAuto: false,
 *     enabled: true,
 *     link: "http://localhost",
 ...
 *
 * ```sh
 *  $ pulumi import whisparr:ImportLists/importListCouchPotato:ImportListCouchPotato example 1
 * ```
 */
export class ImportListCouchPotato extends pulumi.CustomResource {
    /**
     * Get an existing ImportListCouchPotato resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ImportListCouchPotatoState, opts?: pulumi.CustomResourceOptions): ImportListCouchPotato {
        return new ImportListCouchPotato(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'whisparr:ImportLists/importListCouchPotato:ImportListCouchPotato';

    /**
     * Returns true if the given object is an instance of ImportListCouchPotato.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ImportListCouchPotato {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ImportListCouchPotato.__pulumiType;
    }
    ...
    /**
     * Create a ImportListCouchPotato resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ImportListCouchPotatoArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ImportListCouchPotatoArgs | ImportListCouchPotatoState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ImportListCouchPotatoState | undefined;
            ...
            const args = argsOrState as ImportListCouchPotatoArgs | undefined;
            ...
            if ((!args || args.onlyActive === undefined) && !opts.urn) {
                throw new Error("Missing required property 'onlyActive'");
            }
        ...
        super(ImportListCouchPotato.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * Input properties used for looking up and filtering ImportListCouchPotato resources.
 */
export interface ImportListCouchPotatoState {
    /**
     * API key.
     */
...
/**
 * The set of arguments for constructing a ImportListCouchPotato resource.
 */
export interface ImportListCouchPotatoArgs {
    /**
     * API key.
     */
    apiKey: pulumi.Input<string>;
