 ...
 *
 * const example = new whisparr.downloadclients.DownloadClientNzbvortex("example", {
 *     enable: true,
 *     host: "nzbvortex",
 *     name: "Example",
 *     port: 6789,
 ...
 *
 * ```sh
 *  $ pulumi import whisparr:DownloadClients/downloadClientNzbvortex:DownloadClientNzbvortex example 1
 * ```
 */
export class DownloadClientNzbvortex extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'whisparr:DownloadClients/downloadClientNzbvortex:DownloadClientNzbvortex';
