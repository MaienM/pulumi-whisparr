 ...
 *
 * const example = new whisparr.downloadclients.DownloadClientTransmission("example", {
 *     enable: true,
 *     host: "transmission",
 *     name: "Example",
 *     port: 9091,
 ...
 *
 * ```sh
 *  $ pulumi import whisparr:DownloadClients/downloadClientTransmission:DownloadClientTransmission example 1
 * ```
 */
export class DownloadClientTransmission extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'whisparr:DownloadClients/downloadClientTransmission:DownloadClientTransmission';
