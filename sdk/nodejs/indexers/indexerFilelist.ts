 ...
 *
 * const example = new whisparr.indexers.IndexerFilelist("example", {
 ...
 *
 * ```sh
 *  $ pulumi import whisparr:Indexers/indexerFilelist:IndexerFilelist example 1
 * ```
 */
export class IndexerFilelist extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'whisparr:Indexers/indexerFilelist:IndexerFilelist';
