 ...
 *
 * const example = new whisparr.indexers.IndexerTorznab("example", {
 *     apiPath: "/nabapi",
 ...
 *
 * ```sh
 *  $ pulumi import whisparr:Indexers/indexerTorznab:IndexerTorznab example 1
 * ```
 */
export class IndexerTorznab extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'whisparr:Indexers/indexerTorznab:IndexerTorznab';
